...
{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/songs-search-fix.png" alt="" caption="Bruce doesn't have any songs with Racing in the title" %}
...
[placeholder.png]
{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/placeholder.png" alt="" caption="new placeholder date card" %}
...
[onstage.png]
{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/onstage.png" alt="" caption="Reduced padding in the onstage card for non-band personnel" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/songs-page-before.png" alt="" caption="Two tabs" %}

{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/songs-page-after.png" alt="" caption="Everything on a single tab" %}

### "X Shows Ago"
Song detail pages now show how many shows it has been since a song was last played next to the date it was last played.

{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/x-shows-ago.png" alt="" caption="Now you can see exactly how many shows since a songs last performance" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-01-27-databruce-1.13/event-search.png" alt="" caption="Event search dropdown, back by (hopefully) popular demand" %}

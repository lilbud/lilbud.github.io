...
{% include figurehalf img1="/assets/img/blog/2026-04-03-databruce-1.15/profile-before.png" img2="/assets/img/blog/2026-04-03-databruce-1.15/profile-after.png" alt="" caption="This profile is much more interesting looking than mine, also the user with the most shows logged (125)" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/profile-albums-percent.png" alt="Albums by percent" caption="This was surprisingly more complex than you'd think" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/venue map.png" alt="Map showing the Xfinity Mobile Arena" caption="R.I.P. Pierre, I will continue your legacy of hating corporate venue names" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/relation-birthday.png" alt="Adele Springsteen birthday" caption="The reason this site exists at all" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/badges.png" alt="Badges indicating how many shows/songs on a tour" caption="I don't expect that songs number to increase drastically" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/event type search.png" alt="Search box showing multiple event types to search" caption="A barely held together search gets another barely held together feature" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/eventtypes.jpg" alt="All event types on the site" caption="Most of these were borrowed from Brucebase" %}

# New Page: Events By Type

{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/events by type.png" alt="Table showing all 'Benefit Concert' events" caption="This only made sense given the feature above" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/calendar.jpg" alt="April 2026 Event Calendar" caption="" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-04-03-databruce-1.15/birthdays-month.jpg" alt="Calendar with too many events" caption="Would you believe me if I said this was one of the less busy months?" %}

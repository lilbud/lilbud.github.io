...
{% include figure popup=true image_path="/assets/img/blog/2026-06-14-databruce-1.17/profile.jpg" alt="User Profile Cards" caption="A bit nicer looking than badges." %}
...
{% include figure popup=true image_path="/assets/img/blog/2026-06-14-databruce-1.17/discord.png" alt="Discord embed showing stats" caption="Lookup anyone's stats at a moments notice" %}
...
<figure class="half">
    <a href="/assets/img/blog/2026-06-14-databruce-1.17/search-boston.png"><img src="/assets/img/blog/2026-06-14-databruce-1.17/search-boston.png"></a>
    <a href="/assets/img/blog/2026-06-14-databruce-1.17/search-big.png"><img src="/assets/img/blog/2026-06-14-databruce-1.17/search-big.png"></a>
    <figcaption>More indepth searching</figcaption>
</figure>
...
{% include figure popup=true image_path="/assets/img/blog/2026-06-14-databruce-1.17/event_info.png" alt="Event Info" caption="This might expand later, I dunno" %}

Also worth mentioning is that the "attended" button now shows a list of users present on hover.

{% include figure popup=true image_path="/assets/img/blog/2026-06-14-databruce-1.17/user_list.png" alt="List of users at Berlin 2025" caption="This is the most attended show on the site" %}

# Venue Changes

{% include figure popup=true image_path="/assets/img/blog/2026-06-14-databruce-1.17/monmouth.jpg" alt="User Profile Cards" caption="A bit nicer looking than badges." %}

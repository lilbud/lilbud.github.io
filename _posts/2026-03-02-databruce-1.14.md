...
{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/home.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/home.png" alt="" caption="Home Page" %}

{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/event.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/event.png" alt="" caption="Events Page" %}

{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/event-detail.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/event-detail.png" alt="" caption="Event Detail" %}

{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/profile.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/profile.png" alt="" caption="User Profile" %}

{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/release-detail.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/release-detail.png" alt="" caption="Release Detail" %}

{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/song-detail.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/song-detail.png" alt="" caption="Song Detail" %}

{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/advanced-search.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/advanced-search.png" alt="" caption="Advanced Search" %}
...
{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/dark-theme.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/dark-theme.png" alt="" caption="Dark Theme, now with more contrast" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/setlist-scroll.gif" alt="New Sorting Menu" caption="This was the cause of many headaches" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/column-control.png" alt="New Sorting Menu" caption="New Sorting Menu" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/onstage-table.png" alt="New Onstage Table" caption="A table is much nicer than the cramped card" %}

## Album Breakdown

{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/breakdown-compare.png" alt="Album Breakdown Before and After" caption="Album Breakdown Before and After" %}
...
{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/breakdown-show.gif" img2="/assets/img/blog/2026-03-02-databruce-1.14/breakdown-expand.gif" alt="" caption="Gifs showing the expandable rows, as well as the expand all." %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/album-complete.png" alt="Complete Album on Breakdown Card" caption="One of only 2, do it again Bruce" %}

## Setlist Table

{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/setlist-compare.png" alt="Setlist Card Comparison" caption="The new table is more compact" %}
...
{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/debut_premiere.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/nobruce.png" alt="" caption="New search options!" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/release-calendar.png" alt="Release on Calendar" caption="Releases now show on calendar" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/after/profile.png" alt="New profile page" caption="First and Last column on user profile song cards" %}
...
{% include figurehalf img1="/assets/img/blog/2026-03-02-databruce-1.14/before/slots.png" img2="/assets/img/blog/2026-03-02-databruce-1.14/after/slots.png" alt="" caption="Unused Columns are Dropped Now" %}
...
{% include figure popup=true img1="/assets/img/blog/2026-03-02-databruce-1.14/theme-toggle.png" alt="New Theme Toggle" caption="Theme Switcher is now a button" %}
